...
This document serves as the **central source of truth** for all beneficiary validation rules across the IOM Migration Platform. These rules are implemented in multiple locations and should be kept in sync:
...
|-------|----------|----------|-------------------|---------------|------------------|----------------|
| **First Name** | `firstName` | ✅ Yes | Max: 43 chars | String | Non-empty, trimmed | - |
