...
Comprehensive architecture documentation is available in `Platform/docs/architecture/` covering:

- **Domain Template Structure**: Complete project structure for new domains
- **Event-Driven Patterns**: Domain events, ownership, versioning
- **NServiceBus Patterns**: Commands, sagas, handlers, messaging
- **Data Patterns**: CosmosDB strategies, repositories, CQRS
- **UI Architecture**: React micro-frontends, Module Federation
- **Validation Workflow**: Markdown-driven validation with GitHub Actions
- **Bulk Import Pattern**: CSV/Excel upload with validation and progress tracking
- **SignalR Patterns**: Real-time communication and progress notifications
- **Requirements Templates**: Business requirements format
- **Event Storming Guide**: Domain discovery and modeling
- **Scaffolding Prompts**: GitHub Copilot prompts for code generation

See `Platform/docs/architecture/README.md` for complete navigation.
