# AcmeCorp Platform UI

A React-based micro-frontend application for the AcmeCorp Migration Platform with a focus on beneficiary bulk import functionality.
...
The application uses AcmeCorp's official color scheme:

- **Primary Blue**: #0072CE (AcmeCorp Blue)
- **Secondary Orange**: #FF6B35 (AcmeCorp Orange)
