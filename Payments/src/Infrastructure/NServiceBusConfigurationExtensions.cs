...
using Beneficiary.Domain.Contracts;
    ...
    public static class NServiceBusConfigurationExtensions
    {
            ...
            Action<IConfiguration, ServiceBusTriggeredEndpointConfiguration> configurationAction = null)
        {
            ...
            return hostBuilder.UseNServiceBus(endpointName, (configuration, endpointConfiguration) =>
            {
                ...
                var cosmosDbDatabase = "BeneficiaryIntegrationDB";
                var cosmosDbContainer = "BeneficiaryMessagev1";
...
.DatabaseName(cosmosDbDatabase);
                ...
                persistence.DefaultContainer(containerName: cosmosDbContainer, partitionKeyPath: containerPartitionKey);
                var tx = persistence.TransactionInformation();
                tx.ExtractPartitionKeyFromMessage<Beneficiary.Domain.Contracts.IProvideCorrelationId>(providerId =>
                {
